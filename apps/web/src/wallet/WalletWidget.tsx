    ...
    <div className="wallet-widget">
      ...
      {open && (
        <div className="wallet-panel card">
          <div className="tiny muted" style={{ marginBottom: 4 }}>Connected wallet</div>
          ...
          <div className="stat-row"><span className="k">{w.balances?.mintLabel?.split(" · ")[0] ?? "USDC"}</span><span className="v mono">{w.balances ? tokenAmount.toFixed(2) : "…"}</span></div>
          ...
          <p className="tiny faint" style={{ marginTop: 6, lineHeight: 1.4 }}>
            Mints USDC and a little gas SOL to your wallet, free.
          </p>
